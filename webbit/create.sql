...
ALTER TABLE TEM_OCORRENCIA ADD CONSTRAINT UNQ_TEM_OCORRENCIA_0 UNIQUE (NOME)
ALTER TABLE DETALHE_OCORRENCIA ADD CONSTRAINT UNQ_DETALHE_OCORRENCIA_0 UNIQUE (NOME)
